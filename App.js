...
const App = () => {
  ...
  const agregarCliente = () => {
    ...
    const nuevoCliente = { id: clientes.length + 1, nombre: nombre, carnet: carnet, materia: materia, fechaReserva: fechaReserva };
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.clienteFormulario}>FORMULARIO DE REGISTRO DE ALUMNO</Text>
